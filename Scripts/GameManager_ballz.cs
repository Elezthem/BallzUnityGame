...
public class GameManager_ballz : MonoBehaviour
{
    public static GameManager_ballz Instance;
            ...
            switch(value)
            {
                ...
                case GameState.Playable:
                    ...
                    else
                    {
                        ...
                        ScoreManager_ballz.Instance.m_ScoreText.text = BrickSpawner.Instance.m_LevelOfFinalBrick.ToString();
                ...
                case GameState.GameOver:
                    ...
                    m_GameOverFinalScore.text = "Итоговый счет : " + (BrickSpawner.Instance.m_LevelOfFinalBrick - 1).ToString();
